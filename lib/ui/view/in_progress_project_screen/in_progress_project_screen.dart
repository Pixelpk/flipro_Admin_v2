...
class InProgressProjectScreen extends StatefulWidget {
  const InProgressProjectScreen({
    Key? key,
  }) : super(key: key);

  @override
  State<InProgressProjectScreen> createState() => _InProgressProjectScreenState();
}
