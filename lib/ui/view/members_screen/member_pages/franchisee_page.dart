...
class FranchiseePage extends StatefulWidget {
  ...
  @override
  _FranchiseePageState createState() => _FranchiseePageState();
}
...
class _FranchiseePageState extends State<FranchiseePage> {
  ...
  Future<void> _fetchPage(int pageKey) async {
    try {
      final newItems = await UsersService.getUsers(page:pageKey, type: 'franchise',token: Provider.of<UserProvider>(context).getAuthToken);
