...
class MemberTabBar extends StatefulWidget {
  const MemberTabBar({Key? key, required this.pageController,required this.pageControllerIndex})
      : super(key: key);
...
class _MemberTabBarState extends State<MemberTabBar> {
  ...
  Expanded tabBar(
    ...
    return Expanded(
        child: InkWell(
          onTap: () {
            widget.pageController.animateToPage(localindex,
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
                color: widget.pageControllerIndex == localindex
