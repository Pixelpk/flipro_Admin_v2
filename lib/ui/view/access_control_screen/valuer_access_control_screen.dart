...
class ValuerAccessControlScreen extends StatelessWidget {
  const ValuerAccessControlScreen({Key? key}) : super(key: key);
  static const routeName = '/ValuerAccessControlScreen';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: const AccessControlAppBar(title: "Valuer",imageUrl: '',),
      ),
      body: ChangeNotifierProxyProvider<LoadedProjectProvider,
        ...
        update: (context, loadedProvider, projectsProvider) =>
            AccessControlProvider(
                projectRoles: loadedProvider.getValuerRoleById(receivedObject.userRoleModel.id)),
                      ...
                      children: [
                        MainButton(
                          ...
                          callback: () async {
                            ...
                            if(projectAssigned)
                            {
                              Provider.of<ProjectsProvider>(context,listen: false).removeProject(projectId: loadedProject.getLoadedProject!.id);
                            }
                          },
                        ),
                      ],
