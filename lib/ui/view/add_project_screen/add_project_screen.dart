...
class _AddProjectScreenState extends State<AddProjectScreen> {
              ...
              child: Form(
                  ...
                  LabeledTextField(
                    ...
                    Container(
                        ...
                        child: Row(children: [
                          Text("Cross-Collaterized", style: Theme.of(context).textTheme.subtitle1!.copyWith(color: AppColors.greyFontColor)),
                          const Spacer(),
                          Row(children: [
                            Checkbox(
                            ...
                            Text("YES", style: Theme.of(context).textTheme.subtitle1!.copyWith(color: AppColors.greyFontColor))
                          ]),
                          Row(children: [
                            Checkbox(
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(60)),
                            ...
                            Text("NO", style: Theme.of(context).textTheme.subtitle1!.copyWith(color: AppColors.greyFontColor))
                          ])
                        ])),
                    SizedBox(height: 5.h),
  ...
  initControllers() {
    if (widget.project != null) {
      ...
      applicantPhoneController = MaskedTextController(text: project.phone!, mask: '+00 000 000 000');
      applicantAddressController = TextEditingController(text: project.applicantAddress!);
      registeredOwnerController = TextEditingController(text: rememberMe == true ? project.applicantName : project.registeredOwners!);
      ...
      applicantPhoneController = MaskedTextController(text: "+61", mask: '+00 000 000 000');
